...
class P1ParityValidatorTests(unittest.TestCase):
    ...
    def test_report_covers_the_selected_todo_items(self):
        ...
        plush_geometries = list((REPO_ROOT / "source_extracted/assets/thebrokenscript/geo/plush").glob("*.geo.json"))
        self.assertEqual(125 + len(plush_geometries), self.report["content"]["bedrock_block_count"])
