...
extends ChatResponse {
    ...
    public FeverHomesResponse() {
        Object[] objectArray = new String[]{"What are those houses?", "What are those structures?", "What are those homes?", "What are those buildings?"};
    ...
    protected void respond(@NotNull ServerLevel level, @NotNull ServerPlayer sender) {
        Intrinsics.checkNotNullParameter((Object)level, (String)"level");
        Intrinsics.checkNotNullParameter((Object)sender, (String)"sender");
        sender.sendSystemMessage((Component)TBSLang.INSTANCE.getFEVER_MSG_HOMES());
