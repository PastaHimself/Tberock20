...
extends ActionPacket<OpenCreditsPacket> {
    ...
    public void handle(@NotNull PacketHandlerContext cx) {
        ...
        cx.getEnqueueWork().invoke(OpenCreditsPacket::handle$lambda$0);
    }
