...
@Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0000\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\u00a2\u0006\u0004\b\u0003\u0010\u0004J\u0018\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\u00022\u0006\u0010\f\u001a\u00020\rH\u0016R\u0014\u0010\u0005\u001a\u00020\u0006X\u0096\u0004\u00a2\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b\u00a8\u0006\u000e"}, d2={"Lnet/thebrokenscript/network/RockDropPacket;", "Lnet/thebrokenscript/brokencore/api/network/EndecPacket;", "Lnet/thebrokenscript/network/FracturedEndecData;", "<init>", "()V", "id", "Lnet/minecraft/resources/ResourceLocation;", "getId", "()Lnet/minecraft/resources/ResourceLocation;", "handle", "", "data", "cx", "Lnet/thebrokenscript/brokencore/api/network/PacketHandlerContext;", "thebrokenscript-common"})
@SourceDebugExtension(value={"SMAP\nRockDropPacket.kt\nKotlin\n*S Kotlin\n*F\n+ 1 RockDropPacket.kt\nnet/thebrokenscript/network/RockDropPacket\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,41:1\n774#2:42\n865#2,2:43\n*S KotlinDebug\n*F\n+ 1 RockDropPacket.kt\nnet/thebrokenscript/network/RockDropPacket\n*L\n35#1:42\n35#1:43,2\n*E\n"})
public final class RockDropPacket
extends EndecPacket<RockDropPacket, FracturedEndecData> {
    @NotNull
    private final ResourceLocation id = TBSConstants.id("rock_drop");

    public RockDropPacket() {
    ...
    public void handle(@NotNull FracturedEndecData data, @NotNull PacketHandlerContext cx) {
        ...
        cx.getEnqueueWork().invoke(() -> RockDropPacket.handle$lambda$0(cx, data));
    }
    ...
    private static final void handle$lambda$0(PacketHandlerContext $cx, FracturedEndecData $data) {
        ...
        AirLiftAttack.Companion.dropRock(ent, JomlVecExtKt.toVec3((Vector3d)$data.getStartPos()));
        Vec3 pos = ent.getPos();
        TheBrokenScript.serverWorkQueue.add(25L, () -> RockDropPacket.handle$lambda$0$0((Level)level, pos, ent));
    }

    /*
     * WARNING - void declaration
     */
    private static final Unit handle$lambda$0$0(Level $level, Vec3 $pos, FracturedEntity $ent) {
        void $this$filterTo$iv$iv;
        void $this$filter$iv;
        List playersInRange = EntityFinder.findPlayersInRange((LevelAccessor)((LevelAccessor)$level), (Vec3)$pos, (Number)32);
        Iterable iterable = playersInRange;
        FracturedEntity fracturedEntity = $ent;
        ...
        fracturedEntity.setEntityList(CollectionsKt.toMutableList((Collection)((List)destination$iv$iv)));
        DamageSource damageSource = $ent.damageSources().source(TBSDamageTypes.ROCK.getKey());
        Intrinsics.checkNotNullExpressionValue((Object)damageSource, (String)"source(...)");
        $ent.hurtMultipleTargets(12.0f, 10.0, damageSource);
