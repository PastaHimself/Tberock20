...
@Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0000\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\u00a2\u0006\u0004\b\u0003\u0010\u0004J\u0018\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\u00022\u0006\u0010\f\u001a\u00020\rH\u0016R\u0014\u0010\u0005\u001a\u00020\u0006X\u0096\u0004\u00a2\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b\u00a8\u0006\u000e"}, d2={"Lnet/thebrokenscript/network/JimmySlamHitPacket;", "Lnet/thebrokenscript/brokencore/api/network/EndecPacket;", "Lnet/thebrokenscript/network/FracturedEndecData;", "<init>", "()V", "id", "Lnet/minecraft/resources/ResourceLocation;", "getId", "()Lnet/minecraft/resources/ResourceLocation;", "handle", "", "data", "cx", "Lnet/thebrokenscript/brokencore/api/network/PacketHandlerContext;", "thebrokenscript-common"})
@SourceDebugExtension(value={"SMAP\nJimmySlamHitPacket.kt\nKotlin\n*S Kotlin\n*F\n+ 1 JimmySlamHitPacket.kt\nnet/thebrokenscript/network/JimmySlamHitPacket\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,30:1\n774#2:31\n865#2,2:32\n*S KotlinDebug\n*F\n+ 1 JimmySlamHitPacket.kt\nnet/thebrokenscript/network/JimmySlamHitPacket\n*L\n25#1:31\n25#1:32,2\n*E\n"})
public final class JimmySlamHitPacket
extends EndecPacket<JimmySlamHitPacket, FracturedEndecData> {
    @NotNull
    private final ResourceLocation id = TBSConstants.id("slam_hit");

    public JimmySlamHitPacket() {
    ...
    public void handle(@NotNull FracturedEndecData data, @NotNull PacketHandlerContext cx) {
        ...
        cx.getEnqueueWork().invoke(() -> JimmySlamHitPacket.handle$lambda$0(cx, data));
    }
    ...
    private static final void handle$lambda$0(PacketHandlerContext $cx, FracturedEndecData $data) {
        ...
        List playersInRange = EntityFinder.findPlayersInRange((LevelAccessor)((LevelAccessor)level), (Vec3)JomlVecExtKt.toVec3((Vector3d)$data.getStartPos()), (Number)512);
        ...
        entity.hurtMultipleTargets(12.0f, 30.0, damageSource);
    }
}
