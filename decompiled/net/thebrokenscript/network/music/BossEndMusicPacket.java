...
@Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\u00a2\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u0016R\u0014\u0010\b\u001a\u00020\tX\u0096\u0004\u00a2\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000b\u00a8\u0006\f"}, d2={"Lnet/thebrokenscript/network/music/BossEndMusicPacket;", "Lnet/thebrokenscript/brokencore/api/network/ActionPacket;", "<init>", "()V", "handle", "", "cx", "Lnet/thebrokenscript/brokencore/api/network/PacketHandlerContext;", "id", "Lnet/minecraft/resources/ResourceLocation;", "getId", "()Lnet/minecraft/resources/ResourceLocation;", "thebrokenscript-common"})
public final class BossEndMusicPacket
extends ActionPacket<BossEndMusicPacket> {
    @NotNull
    private final ResourceLocation id = TBSConstants.id("integrity_end_music");
    ...
    public void handle(@NotNull PacketHandlerContext cx) {
        ...
        cx.getEnqueueWork().invoke(BossEndMusicPacket::handle$lambda$0);
    }
    ...
    private static final void handle$lambda$0() {
        ...
        FancyAudio.INSTANCE.stop((SoundEvent)IntegrityBossTracks.INSTANCE.getTRACK_PART_2_BRIDGE().get());
        FancyAudio.INSTANCE.stop((SoundEvent)IntegrityBossTracks.INSTANCE.getTRACK_PART_3().get());
        FancyAudio.play$default((FancyAudio)FancyAudio.INSTANCE, (SoundEvent)((SoundEvent)IntegrityBossTracks.INSTANCE.getTRACK_END().get()), (SoundSource)TBSSoundCategories.TBS_MUSIC, (float)0.0f, (float)0.0f, (boolean)false, null, (int)60, null);
    }
}
