...
@Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\u00a2\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016R\u0014\u0010\u0004\u001a\u00020\u0005X\u0096\u0004\u00a2\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007\u00a8\u0006\f"}, d2={"Lnet/thebrokenscript/network/SyncMusicTimerPacket;", "Lnet/thebrokenscript/brokencore/api/network/ActionPacket;", "<init>", "()V", "id", "Lnet/minecraft/resources/ResourceLocation;", "getId", "()Lnet/minecraft/resources/ResourceLocation;", "handle", "", "cx", "Lnet/thebrokenscript/brokencore/api/network/PacketHandlerContext;", "thebrokenscript-common"})
public final class SyncMusicTimerPacket
extends ActionPacket<SyncMusicTimerPacket> {
    @NotNull
    private final ResourceLocation id = TBSConstants.id("music_timer_sync");
    ...
    public void handle(@NotNull PacketHandlerContext cx) {
        ...
        if (!cx.isClientbound) {
            cx.getEnqueueWork().invoke(() -> SyncMusicTimerPacket.handle$lambda$0(cx));
        }
    }
    ...
    private static final void handle$lambda$0(PacketHandlerContext $cx) {
        block0: {
            ...
            PlayerExt.INSTANCE.updateVars(player, (Function1<? super PlayerVariables, Unit>)((Function1)SyncMusicTimerPacket::handle$lambda$0$0));
        }
    }
    ...
    private static final Unit handle$lambda$0$0(PlayerVariables $this$updateVars) {
        ...
        $this$updateVars.setMusicTimer(0);
