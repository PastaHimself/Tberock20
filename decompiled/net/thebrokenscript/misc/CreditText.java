...
extends CreditInfo {
    ...
    public CreditText(@NotNull String content) {
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$thebrokenscript_common(CreditText self, CompositeEncoder output, SerialDescriptor serialDesc) {
        CreditInfo.write$Self(self, output, serialDesc);
        output.encodeStringElement(serialDesc, 0, self.content);
    }

    public /* synthetic */ CreditText(int seen0, String content, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (1 & seen0)) {
    ...
    @Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005\u00a8\u0006\u0007"}, d2={"Lnet/thebrokenscript/misc/CreditText$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lnet/thebrokenscript/misc/CreditText;", "thebrokenscript-common"})
    public static final class Companion {
        private Companion() {
        }

        @NotNull
        public final KSerializer<CreditText> serializer() {
