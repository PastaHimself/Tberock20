...
@ForceRuntimeInit
@Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\b\u00c7\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0002\u0010\u0003J\"\u0010\u0004\u001a\u0004\u0018\u00010\u00052\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0002\u00a8\u0006\u000b"}, d2={"Lnet/thebrokenscript/world/dimension/lucid/LucidDimension;", "", "<init>", "()V", "findSafeSpot", "Lnet/minecraft/core/BlockPos;", "blockPos", "level", "Lnet/minecraft/server/level/ServerLevel;", "depth", "", "thebrokenscript-common"})
public final class LucidDimension {
    @NotNull
    public static final LucidDimension INSTANCE = new LucidDimension();

    private LucidDimension() {
    }
    ...
    private static final Unit _init_$lambda$0(PlayerEvents.ChangeDimension $this$on) {
        ...
        if (Intrinsics.areEqual((Object)$this$on.getFrom(), TBSDimensions.LUCID)) {
            PlayerExt.INSTANCE.updateVars((Player)$this$on.getPlayer(), (Function1<? super PlayerVariables, Unit>)((Function1)LucidDimension::lambda$0$0));
        }
        if (!Intrinsics.areEqual((Object)$this$on.getTo(), TBSDimensions.LUCID)) {
            return Unit.INSTANCE;
        }
        PlayerExt.INSTANCE.updateVars((Player)$this$on.getPlayer(), (Function1<? super PlayerVariables, Unit>)((Function1)LucidDimension::lambda$0$1));
        $this$on.getPlayer().level().getChunk($this$on.getPlayer().getBlockX() >> 4, $this$on.getPlayer().getBlockZ() >> 4);
        if (PlayerExt.INSTANCE.getVars((Player)$this$on.getPlayer()).getFixPos()) {
            ...
            WorkQueue.add$default((WorkQueue)TheBrokenScript.serverWorkQueue, (long)0L, () -> LucidDimension.lambda$0$2($this$on), (int)1, null);
            TheBrokenScript.serverWorkQueue.add(1L, () -> LucidDimension.lambda$0$3($this$on));
        }
        return Unit.INSTANCE;
    }
    ...
    private static final Unit lambda$0$1(PlayerVariables $this$updateVars) {
        Intrinsics.checkNotNullParameter((Object)$this$updateVars, (String)"$this$updateVars");
        $this$updateVars.setPixelateEnabled(true);
        return Unit.INSTANCE;
    }

    private static final Unit lambda$0$2(PlayerEvents.ChangeDimension $this_on) {
        ServerLevel level = $this_on.getPlayer().serverLevel();
        PlayerExt.INSTANCE.updateVars((Player)$this_on.getPlayer(), (Function1<? super PlayerVariables, Unit>)((Function1)LucidDimension::lambda$0$2$0));
    ...
    private static final Unit lambda$0$2$0(PlayerVariables $this$updateVars) {
        Intrinsics.checkNotNullParameter((Object)$this$updateVars, (String)"$this$updateVars");
        $this$updateVars.setSkipFallDamage(true);
        return Unit.INSTANCE;
    }

    private static final Unit lambda$0$3(PlayerEvents.ChangeDimension $this_on) {
        ...
        PlayerExt.INSTANCE.getVars((Player)$this_on.getPlayer()).setTicksUntilExit(2000L);
    ...
    static {
        GameEvent.Companion.on(PlayerEvents.CHANGE_DIMENSION, LucidDimension::_init_$lambda$0);
    }
}
