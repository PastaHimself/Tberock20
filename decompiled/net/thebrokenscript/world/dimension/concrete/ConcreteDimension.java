...
@ForceRuntimeInit
@Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\b\u00c7\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0002\u0010\u0003\u00a8\u0006\u0004"}, d2={"Lnet/thebrokenscript/world/dimension/concrete/ConcreteDimension;", "", "<init>", "()V", "thebrokenscript-common"})
public final class ConcreteDimension {
    @NotNull
    public static final ConcreteDimension INSTANCE = new ConcreteDimension();

    private ConcreteDimension() {
    }
    ...
    private static final Unit _init_$lambda$0(PlayerEvents.ChangeDimension $this$on) {
        ...
        if (!Intrinsics.areEqual((Object)$this$on.getTo(), TBSDimensions.CONCRETE)) {
        ...
        if (PlayerExt.INSTANCE.getVars((Player)$this$on.getPlayer()).getFixPos()) {
            ...
            PlayerExt.INSTANCE.updateVars((Player)$this$on.getPlayer(), (Function1<? super PlayerVariables, Unit>)((Function1)ConcreteDimension::lambda$0$0));
            WorkQueue.add$default((WorkQueue)TheBrokenScript.serverWorkQueue, (long)0L, () -> ConcreteDimension.lambda$0$1($this$on), (int)1, null);
            TheBrokenScript.serverWorkQueue.add(1L, () -> ConcreteDimension.lambda$0$2($this$on));
        }
        return Unit.INSTANCE;
    }
    ...
    private static final Unit lambda$0$1(PlayerEvents.ChangeDimension $this_on) {
        EntityUtil.teleport((Entity)((Entity)$this_on.getPlayer()), (BlockPos)PositionUtil.withY((BlockPos)new BlockPos(3, 0, $this_on.getPlayer().getBlockZ()), (Number)237));
        return Unit.INSTANCE;
    }
    ...
    private static final Unit lambda$0$2(PlayerEvents.ChangeDimension $this_on) {
        ...
        PlayerExt.INSTANCE.getVars((Player)$this_on.getPlayer()).setTicksUntilExit(1600L);
    ...
    static {
        GameEvent.Companion.on(PlayerEvents.CHANGE_DIMENSION, ConcreteDimension::_init_$lambda$0);
    }
}
