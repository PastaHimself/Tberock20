...
import net.thebrokenscript.client.model.entity.ObliterationModel;
...
extends GeoEntityRenderer<ObliterationEntity> {
    ...
    public boolean shouldRender(@NotNull ObliterationEntity entity, @NotNull Frustum frustum, double x, double y, double z) {
        Intrinsics.checkNotNullParameter((Object)((Object)entity), (String)"entity");
    ...
    @Nullable
    public RenderType getRenderType(@NotNull ObliterationEntity animatable, @Nullable ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {
