...
import net.thebrokenscript.client.model.entity.HetzerModel;
...
extends GeoEntityRenderer<HetzerEntity> {
    ...
    public void actuallyRender(@NotNull PoseStack poseStack, @NotNull HetzerEntity entity, @Nullable BakedGeoModel model2, @Nullable RenderType renderType, @NotNull MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
    ...
    public void preRender(@Nullable PoseStack poseStack, @Nullable HetzerEntity entity, @Nullable BakedGeoModel model2, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
        float scale;
