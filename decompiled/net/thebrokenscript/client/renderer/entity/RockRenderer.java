...
extends GeoEntityRenderer<RockEntity> {
    ...
    protected void applyRotations(@NotNull RockEntity animatable, @NotNull PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
        ...
        PoseStackExt.INSTANCE.scale(poseStack, (Number)Float.valueOf(35.0f));
    }
}
