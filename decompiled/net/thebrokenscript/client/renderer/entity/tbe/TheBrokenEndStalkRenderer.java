...
import net.thebrokenscript.client.model.entity.TheBrokenEndStalkModel;
...
extends GeoEntityRenderer<TheBrokenEndStalkEntity> {
    ...
    protected void applyRotations(@NotNull TheBrokenEndStalkEntity entity, @NotNull PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
        Intrinsics.checkNotNullParameter((Object)((Object)entity), (String)"entity");
        Intrinsics.checkNotNullParameter((Object)poseStack, (String)"poseStack");
