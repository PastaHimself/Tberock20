...
@Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0007\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0006\n\u0002\b\u0003\u0018\u0000 \u00192\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u0019B\u001f\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007\u00a2\u0006\u0004\b\b\u0010\tJ(\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u0011H\u0014J \u0010\u0013\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u00112\u0006\u0010\u0010\u001a\u00020\u0011H\u0014J\b\u0010\u0014\u001a\u00020\u0015H\u0016J \u0010\u0016\u001a\u00020\u00152\u0006\u0010\u000e\u001a\u00020\u00172\u0006\u0010\u0010\u001a\u00020\u00172\u0006\u0010\u0018\u001a\u00020\u0011H\u0016\u00a8\u0006\u001a"}, d2={"Lnet/thebrokenscript/client/gui/PolaroidScreen;", "Lnet/minecraft/client/gui/screens/inventory/AbstractContainerScreen;", "Lnet/thebrokenscript/world/inventory/PolaroidMenu;", "container", "inventory", "Lnet/minecraft/world/entity/player/Inventory;", "text", "Lnet/minecraft/network/chat/Component;", "<init>", "(Lnet/thebrokenscript/world/inventory/PolaroidMenu;Lnet/minecraft/world/entity/player/Inventory;Lnet/minecraft/network/chat/Component;)V", "renderBg", "", "guiGraphics", "Lnet/minecraft/client/gui/GuiGraphics;", "mouseX", "", "mouseY", "", "partialTick", "renderLabels", "shouldCloseOnEsc", "", "mouseClicked", "", "button", "Companion", "thebrokenscript-common"})
@SourceDebugExtension(value={"SMAP\nPolaroidScreen.kt\nKotlin\n*S Kotlin\n*F\n+ 1 PolaroidScreen.kt\nnet/thebrokenscript/client/gui/PolaroidScreen\n+ 2 ComponentDSL.kt\nnet/thebrokenscript/brokencore/api/dsl/ComponentUtil\n*L\n1#1,79:1\n15#2:80\n*S KotlinDebug\n*F\n+ 1 PolaroidScreen.kt\nnet/thebrokenscript/client/gui/PolaroidScreen\n*L\n53#1:80\n*E\n"})
public final class PolaroidScreen
extends AbstractContainerScreen<PolaroidMenu> {
    @NotNull
    public static final Companion Companion = new Companion(null);
    @NotNull
    private static final ResourceLocation texture = TBSConstants.id("textures/screens/polaroid.png");

    public PolaroidScreen(@NotNull PolaroidMenu container, @NotNull Inventory inventory, @NotNull Component text) {
    ...
    protected void renderBg(@NotNull GuiGraphics guiGraphics, float mouseX, int mouseY, int partialTick) {
        ...
        float textScale = (float)((double)2.0f / guiScale);
        pose.pushPose();
        pose.translate(cx, cy, 0.0f);
        pose.mulPose(Axis.ZP.rotationDegrees(15.0f));
        pose.scale(scale, scale, 1.0f);
        pose.translate(-471.0f, -471.0f, 0.0f);
        guiGraphics.blit(texture, 0, 0, 0.0f, 0.0f, 942, 942, this.imageWidth, this.imageHeight);
        pose.popPose();
        pose.pushPose();
        pose.translate(cx, cy, 0.0f);
        pose.mulPose(Axis.ZP.rotationDegrees(15.0f));
        ...
        if (ClientDSLKt.getMC().level != null) {
            ...
            String $this$c$iv = LevelExt.INSTANCE.getVars((LevelAccessor)clientLevel).getCode();
            ...
            guiGraphics.drawString(this.font, component, 65 - this.font.width(LevelExt.INSTANCE.getVars((LevelAccessor)clientLevel2).getCode()) / 2, 100, -16777216, false);
        }
        pose.popPose();
    }
    ...
    @Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004\u00a2\u0006\u0002\n\u0000\u00a8\u0006\u0006"}, d2={"Lnet/thebrokenscript/client/gui/PolaroidScreen$Companion;", "", "<init>", "()V", "texture", "Lnet/minecraft/resources/ResourceLocation;", "thebrokenscript-common"})
