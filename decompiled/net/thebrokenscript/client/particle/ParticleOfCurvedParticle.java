...
extends TextureSheetParticle {
    ...
    public /* synthetic */ ParticleOfCurvedParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet, DefaultConstructorMarker $constructor_marker) {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final TexturedParticleProvider<ParticleOfCurvedParticle> provider(@NotNull SpriteSet spriteSet) {
