...
extends TextureSheetParticle {
    ...
    public /* synthetic */ ChargeLaserParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet, DefaultConstructorMarker $constructor_marker) {
        this(level, x, y, z, vx, vy, vz, spriteSet);
    }

    @Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0002\u0010\u0003J\u0014\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u00052\u0006\u0010\u0007\u001a\u00020\b\u00a8\u0006\t"}, d2={"Lnet/thebrokenscript/client/particle/ChargeLaserParticle$Companion;", "", "<init>", "()V", "provider", "Lnet/thebrokenscript/brokencore/api/client/particle/TexturedParticleProvider;", "Lnet/thebrokenscript/client/particle/ChargeLaserParticle;", "spriteSet", "Lnet/minecraft/client/particle/SpriteSet;", "thebrokenscript-common"})
    public static final class Companion {
        private Companion() {
        }

        @NotNull
        public final TexturedParticleProvider<ChargeLaserParticle> provider(@NotNull SpriteSet spriteSet) {
