...
extends TextureSheetParticle {
    ...
    public /* synthetic */ WretchedParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet, DefaultConstructorMarker $constructor_marker) {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final TexturedParticleProvider<WretchedParticle> provider(@NotNull SpriteSet spriteSet) {
