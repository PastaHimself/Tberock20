...
implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(@NotNull String targetClassName, @NotNull String mixinClassName) {
        ...
        if (StringsKt.contains$default((CharSequence)mixinClassName, (CharSequence)"compat.sodiumextras", (boolean)false, (int)2, null)) {
            return PlatformUtil.Companion.isModLoadedEarly("sodiumextras");
        }
        ...
        if (StringsKt.contains$default((CharSequence)mixinClassName, (CharSequence)"compat.xaero.minimap", (boolean)false, (int)2, null)) {
            return PlatformUtil.Companion.isModLoadedEarly("xaerominimap");
        }
        if (StringsKt.contains$default((CharSequence)mixinClassName, (CharSequence)"compat.xaero.worldmap", (boolean)false, (int)2, null)) {
            return PlatformUtil.Companion.isModLoadedEarly("xaeroworldmap");
        }
        if (StringsKt.contains$default((CharSequence)mixinClassName, (CharSequence)"compat.journeymap", (boolean)false, (int)2, null)) {
            return PlatformUtil.Companion.isModLoadedEarly("journeymap");
        }
        if (StringsKt.contains$default((CharSequence)mixinClassName, (CharSequence)"compat.voicechat", (boolean)false, (int)2, null)) {
            return PlatformUtil.Companion.isModLoadedEarly("voicechat");
        }
        if (StringsKt.contains$default((CharSequence)mixinClassName, (CharSequence)"features.waystones", (boolean)false, (int)2, null)) {
            return PlatformUtil.Companion.isModLoadedEarly("waystones");
        }
        if (StringsKt.contains$default((CharSequence)mixinClassName, (CharSequence)"compat.nomansland", (boolean)false, (int)2, null)) {
            return PlatformUtil.Companion.isModLoadedEarly("nomansland");
        }
        if (StringsKt.contains$default((CharSequence)mixinClassName, (CharSequence)"compat.modernfix", (boolean)false, (int)2, null)) {
            return PlatformUtil.Companion.isModLoadedEarly("modernfix");
        }
        return true;
    }
