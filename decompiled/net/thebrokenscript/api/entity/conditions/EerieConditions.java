...
implements SpawnConditions {
    ...
    public <T extends Entity> SpawnPlacements.SpawnPredicate<T> predicate() {
        return (arg_0, arg_1, arg_2, arg_3, arg_4) -> EerieConditions.predicate$lambda$0(this, arg_0, arg_1, arg_2, arg_3, arg_4);
    }
    ...
    private static final boolean predicate$lambda$0(EerieConditions this$0, EntityType entityType, ServerLevelAccessor world, MobSpawnType reason, BlockPos pos, RandomSource random) {
        ...
        if ((double)random.nextFloat() > 0.0015 + (double)LongExt.INSTANCE.eventFrequency(world.getLevel().getGameTime()) || world.getLevel().isNight()) {
            return false;
        }
        if (LevelExt.INSTANCE.getVars((LevelAccessor)world).getEerieNoiseDelay() > 0) {
            return false;
        }
        LevelExt.INSTANCE.updateVars((LevelAccessor)world, (Function1<? super MapVariables, Unit>)((Function1)EerieConditions::predicate$lambda$0$0));
        return true;
    }
    ...
    private static final Unit predicate$lambda$0$0(MapVariables $this$updateVars) {
        ...
        $this$updateVars.setEerieNoiseDelay(3200);
