...
implements SpawnConditions {
    ...
    public FracturedConditions() {
        ...
        float[] fArray = new float[]{0.01f, 0.02f, 0.03f, 0.04f, 0.05f, 0.06f};
    ...
    public <T extends Entity> SpawnPlacements.SpawnPredicate<T> predicate() {
        return (arg_0, arg_1, arg_2, arg_3, arg_4) -> FracturedConditions.predicate$lambda$0(this, arg_0, arg_1, arg_2, arg_3, arg_4);
    }

    private final boolean hasOtherJimsInRange(LevelAccessor world, BlockPos pos) {
        Vec3 center = Vec3.atCenterOf((Vec3i)((Vec3i)pos));
        Intrinsics.checkNotNull((Object)center);
        Class[] classArray = new Class[]{FracturedEntity.class, FracturedRoamEntity.class};
    ...
    private static final boolean predicate$lambda$0(FracturedConditions this$0, EntityType entityType, ServerLevelAccessor world, MobSpawnType reason, BlockPos pos, RandomSource random) {
        ...
        if (!Intrinsics.areEqual((Object)world.getLevel().dimension(), TBSDimensions.CORRUPTED_MOON)) {
            return false;
        }
        if (Arena.Companion.getInstance() != null && Arena.Companion.getPhase() == ArenaPhase.Phase1) {
            return false;
        }
        if (!LevelExt.INSTANCE.getVars((LevelAccessor)world).getCanFracturedSpawn()) {
            return false;
        }
        if (this$0.hasOtherJimsInRange((LevelAccessor)world, pos)) {
            return false;
        }
