...
implements SpawnConditions {
    ...
    public TBEAmbushConditions() {
        ...
        float[] fArray = new float[]{2.0E-4f, 4.0E-4f, 6.0E-4f, 8.0E-4f, 0.001f, 0.0012f};
        fArrayArray[0] = fArray;
        fArray = new float[]{5.0E-4f, 0.001f, 0.0015f, 0.002f, 0.0025f, 0.003f};
        fArrayArray[1] = fArray;
        fArray = new float[]{0.001f, 0.002f, 0.003f, 0.004f, 0.005f, 0.006f};
    ...
    public <T extends Entity> SpawnPlacements.SpawnPredicate<T> predicate() {
        return (arg_0, arg_1, arg_2, arg_3, arg_4) -> TBEAmbushConditions.predicate$lambda$0(this, arg_0, arg_1, arg_2, arg_3, arg_4);
    }
    ...
    private static final boolean predicate$lambda$0(TBEAmbushConditions this$0, EntityType entityType, ServerLevelAccessor world, MobSpawnType reason, BlockPos pos, RandomSource random) {
        ...
        if (!LevelExt.INSTANCE.getVars((LevelAccessor)world).getHasMoonCorrupted()) {
            return false;
        }
        ...
        int corruptMoonStage = RangesKt.coerceIn((int)LevelExt.INSTANCE.getVars((LevelAccessor)world).getMoonStage(), (int)0, (int)(((Object[])this$0.spawnChanceMatrix).length - 1));
        int inventoryCorruption = RangesKt.coerceIn((int)LevelExt.INSTANCE.getVars((LevelAccessor)world).getInventoryCorruption(), (int)0, (int)(this$0.spawnChanceMatrix[0].length - 1));
        if (random.nextFloat() > this$0.spawnChanceMatrix[corruptMoonStage][inventoryCorruption] + LongExt.INSTANCE.eventFrequency(world.getLevel().getGameTime())) {
            return false;
        }
        LevelExt.INSTANCE.updateVars((LevelAccessor)world, (Function1<? super MapVariables, Unit>)((Function1)TBEAmbushConditions::predicate$lambda$0$0));
        return true;
    }
    ...
    private static final Unit predicate$lambda$0$0(MapVariables $this$updateVars) {
        ...
        $this$updateVars.setTbeSpawnDelay(8200);
