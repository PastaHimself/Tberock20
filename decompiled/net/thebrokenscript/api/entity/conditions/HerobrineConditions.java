...
implements SpawnConditions {
    ...
    public <T extends Entity> SpawnPlacements.SpawnPredicate<T> predicate() {
        return (arg_0, arg_1, arg_2, arg_3, arg_4) -> HerobrineConditions.predicate$lambda$0(this, arg_0, arg_1, arg_2, arg_3, arg_4);
    }
    ...
    private static final boolean predicate$lambda$0(HerobrineConditions this$0, EntityType type, ServerLevelAccessor world, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
        ...
        Intrinsics.checkNotNull((Object)spawnType);
        Intrinsics.checkNotNull((Object)pos);
        if (!this$0.checkMobSpawnRules((EntityType<? extends Entity>)type, levelAccessor, spawnType, pos)) {
            return false;
        }
        ...
        if (!LevelExt.INSTANCE.getVars((LevelAccessor)world).getHasBuiltHerobrineShrine()) {
            return false;
        }
        if ((double)random.nextFloat() > 1.0E-4) {
            return false;
        }
        if (LevelExt.INSTANCE.getVars((LevelAccessor)world).getHerobrineDelay() > 0) {
            return false;
        }
        LevelExt.INSTANCE.updateVars((LevelAccessor)world, (Function1<? super MapVariables, Unit>)((Function1)HerobrineConditions::predicate$lambda$0$0));
        return true;
    }
    ...
    private static final Unit predicate$lambda$0$0(MapVariables $this$updateVars) {
        ...
        $this$updateVars.setHerobrineDelay(32000);
