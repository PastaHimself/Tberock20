...
implements SpawnConditions {
    ...
    public <T extends Entity> SpawnPlacements.SpawnPredicate<T> predicate() {
        return NullConditions::predicate$lambda$0;
    }
    ...
    private static final boolean predicate$lambda$0(EntityType entityType, ServerLevelAccessor world, MobSpawnType mobSpawnType, BlockPos pos, RandomSource random) {
        ...
        if (LevelExt.INSTANCE.getVars((LevelAccessor)world).getNullSpawnDelay() > 0) {
            return false;
        }
        ...
        Class[] classArray = new Class[]{NullFlyingEntity.class, NullMiningEntity.class, NullInvadeBaseEntity.class, NullIsHereEntity.class, NullWatchingEntity.class};
        if (EntityFinder.hasEntitiesInRange((LevelAccessor)levelAccessor, (Vec3)vec3, (Number)120, (Class[])classArray)) {
            return false;
        }
        if (world.getNearestPlayer(pos.getCenter().x, pos.getCenter().y, pos.getCenter().z, 60.0, false) == null) {
            return false;
        }
        LevelExt.INSTANCE.updateVars((LevelAccessor)world, (Function1<? super MapVariables, Unit>)((Function1)NullConditions::predicate$lambda$0$0));
        return true;
    }
    ...
    private static final Unit predicate$lambda$0$0(MapVariables $this$updateVars) {
        ...
        $this$updateVars.setNullSpawnDelay(7200);
