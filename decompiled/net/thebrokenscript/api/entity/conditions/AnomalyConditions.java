...
implements SpawnConditions {
    ...
    public AnomalyConditions() {
        ...
        float[] fArray = new float[]{0.001f, 0.005f, 0.02f, 0.015f, 0.01f, 0.0f, 0.0f, 0.0f};
    ...
    public <T extends Entity> SpawnPlacements.SpawnPredicate<T> predicate() {
        return (arg_0, arg_1, arg_2, arg_3, arg_4) -> AnomalyConditions.predicate$lambda$0(this, arg_0, arg_1, arg_2, arg_3, arg_4);
    }
    ...
    private static final boolean predicate$lambda$0(AnomalyConditions this$0, EntityType entityType, ServerLevelAccessor world, MobSpawnType reason, BlockPos pos, RandomSource random) {
        ...
        if (Intrinsics.areEqual((Object)entityType, (Object)TBSEntities.SUB_ANOMALY_1.get())) {
            ServerLevel serverLevel = world.getLevel();
            Intrinsics.checkNotNullExpressionValue((Object)serverLevel, (String)"getLevel(...)");
            if (!EntityLookupExtImplKt.byClass((LevelEntityGetterAdapter)EntityFinder.getEntities((ServerLevel)serverLevel), SubAnomaly1Entity.class).isEmpty()) {
                return false;
            }
        }
        return true;
