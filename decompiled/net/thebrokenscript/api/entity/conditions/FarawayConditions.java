...
implements SpawnConditions {
    ...
    public <T extends Entity> SpawnPlacements.SpawnPredicate<T> predicate() {
        return (arg_0, arg_1, arg_2, arg_3, arg_4) -> FarawayConditions.predicate$lambda$0(this, arg_0, arg_1, arg_2, arg_3, arg_4);
    }
    ...
    private static final boolean predicate$lambda$0(FarawayConditions this$0, EntityType entityType, ServerLevelAccessor world, MobSpawnType reason, BlockPos pos, RandomSource random) {
        ...
        if (Intrinsics.areEqual((Object)entityType, (Object)TBSEntities.FARAWAY.get())) {
            ServerLevel serverLevel = world.getLevel();
            Intrinsics.checkNotNullExpressionValue((Object)serverLevel, (String)"getLevel(...)");
            if (!EntityLookupExtImplKt.byClass((LevelEntityGetterAdapter)EntityFinder.getEntities((ServerLevel)serverLevel), FarawayEntity.class).isEmpty()) {
                return false;
            }
        }
        return true;
