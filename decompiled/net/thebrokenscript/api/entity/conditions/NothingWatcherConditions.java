...
implements SpawnConditions {
    ...
    public NothingWatcherConditions() {
    ...
    public <T extends Entity> SpawnPlacements.SpawnPredicate<T> predicate() {
        return (arg_0, arg_1, arg_2, arg_3, arg_4) -> NothingWatcherConditions.predicate$lambda$0(this, arg_0, arg_1, arg_2, arg_3, arg_4);
    }

    private final boolean checkMobSpawnRules(EntityType<? extends Entity> type, LevelAccessor level, BlockPos pos) {
        return level.getBlockState(pos.below()).isValidSpawn((BlockGetter)level, pos.below(), type);
    }

    private static final boolean predicate$lambda$0(NothingWatcherConditions this$0, EntityType entityType, ServerLevelAccessor world, MobSpawnType mobSpawnType, BlockPos pos, RandomSource random) {
        ...
        if (!Intrinsics.areEqual((Object)world.getLevel().dimension(), TBSDimensions.NOTHING)) {
            return false;
        }
        ...
        if (!this$0.checkMobSpawnRules((EntityType<? extends Entity>)entityType, levelAccessor, pos)) {
            return false;
        }
        ...
        return EntityLookupExtImplKt.byClass((LevelEntityGetterAdapter)EntityFinder.getEntities((ServerLevel)serverLevel), NothingWatcherEntity.class).size() <= 35;
    }
}
