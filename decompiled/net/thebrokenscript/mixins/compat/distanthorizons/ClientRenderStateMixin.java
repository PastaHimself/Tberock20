...
@Mixin(value={ClientLevelModule.ClientRenderState.class})
public class ClientRenderStateMixin {
    @WrapOperation(method={"<init>"}, at={@At(value="INVOKE", target="Lcom/seibel/distanthorizons/core/config/types/ConfigEntry;get()Ljava/lang/Object;")})
