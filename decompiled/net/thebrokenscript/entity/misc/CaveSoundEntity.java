...
implements FinalizedSpawn {
    ...
    public SpawnGroupData onFinalizeSpawn(@NotNull ServerLevelAccessor level, @NotNull DifficultyInstance difficulty, @NotNull MobSpawnType spawnType, @Nullable SpawnGroupData spawnData, @NotNull CancelProxy event) {
        ...
        SoundUtil.tryBroadcastSoundInRange$default((LevelAccessor)levelAccessor, (Vec3)vec3, (Number)number, (SoundEvent)soundEvent, (float)45.0f, (float)RandomUtil.nextFloat((RandomSource)randomSource, (float)0.0f, (float)1.0f), null, (int)32, null);
