...
implements FinalizedSpawn {
    ...
    public CircuitMineshaftFleeEntity(@NotNull EntityType<CircuitMineshaftFleeEntity> type, @NotNull Level level) {
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(1, (Goal)new CustomGoals.ThrottledAvoidGoal((PathfinderMob)this, 200.0f, 1.5, 2.0));
    ...
    public final int getTimer() {
        return EntityUtil.getPersistentData((Entity)((Entity)this)).getInt(DESPAWN_TIMER);
    }

    public final void setTimer(int value) {
        EntityUtil.getPersistentData((Entity)((Entity)this)).putInt(DESPAWN_TIMER, value);
    }
    ...
    public void baseTick() {
        ...
        boolean bl = isPlayerClose = this.getLevel().getNearestPlayer((Entity)this, 25.0) != null;
        if (this.getTimer() >= 0 && !isPlayerClose) {
            int n = this.getTimer();
            this.setTimer(n + -1);
        }
        if (this.getTimer() <= 0) {
            this.discard();
            EntityUtil.applyRandomRotation((Entity)EntityTypeExt.trySummon((EntityType)((EntityType)TBSEntities.CIRCUIT_MINESHAFT_WALK.get()), (LevelAccessor)((LevelAccessor)this.getLevel()), (Vec3)this.getPos()));
        }
    ...
    public void registerControllers(@NotNull AnimatableManager.ControllerRegistrar reg) {
        ...
        reg.add(new AnimationController((GeoAnimatable)this, "circuit_mineshaft_flee", 0, arg_0 -> CircuitMineshaftFleeEntity.registerControllers$lambda$0(this, arg_0)));
    }

    private static final PlayState registerControllers$lambda$0(CircuitMineshaftFleeEntity this$0, AnimationState it) {
        if (it.isMoving()) {
    ...
    @Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T\u00a2\u0006\u0002\n\u0000\u00a8\u0006\u0006"}, d2={"Lnet/thebrokenscript/entity/circuit/CircuitMineshaftFleeEntity$Companion;", "", "<init>", "()V", "DESPAWN_TIMER", "", "thebrokenscript-common"})
