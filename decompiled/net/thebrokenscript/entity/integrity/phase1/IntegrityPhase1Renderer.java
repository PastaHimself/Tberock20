...
import net.thebrokenscript.entity.integrity.phase1.IntegrityPhase1Model;
...
extends GeoEntityRenderer<IntegrityPhase1Entity> {
    ...
    public void actuallyRender(@NotNull PoseStack poseStack, @NotNull IntegrityPhase1Entity entity, @Nullable BakedGeoModel model2, @Nullable RenderType renderType, @NotNull MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
    ...
    public void preRender(@Nullable PoseStack poseStack, @NotNull IntegrityPhase1Entity entity, @Nullable BakedGeoModel model2, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
        float scale;
        Intrinsics.checkNotNullParameter((Object)((Object)entity), (String)"entity");
