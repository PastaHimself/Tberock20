...
@Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u00c7\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rH\u0002R\u001c\u0010\u0004\u001a\u0004\u0018\u00010\u0005X\u0086\u000e\u00a2\u0006\u000e\n\u0000\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\t\u00a8\u0006\u000e"}, d2={"Lnet/thebrokenscript/handlers/dimensions/ambience/LibraryAmbienceHandler;", "", "<init>", "()V", "instance", "Lnet/thebrokenscript/brokencore/api/sound/FancySoundInstance;", "getInstance", "()Lnet/thebrokenscript/brokencore/api/sound/FancySoundInstance;", "setInstance", "(Lnet/thebrokenscript/brokencore/api/sound/FancySoundInstance;)V", "ambience", "", "mc", "Lnet/minecraft/client/Minecraft;", "thebrokenscript-common"})
public final class LibraryAmbienceHandler {
    @NotNull
    public static final LibraryAmbienceHandler INSTANCE = new LibraryAmbienceHandler();
    @Nullable
    private static FancySoundInstance instance;

    private LibraryAmbienceHandler() {
    }
        ...
        block6: {
            block8: {
                block7: {
                    ...
                    if (!Intrinsics.areEqual((Object)player.level().dimension(), TBSDimensions.LIBRARY)) {
                        return;
                    }
                    ...
                    boolean bl = fancySoundInstance != null ? fancySoundInstance.isStopped() : false;
                    if (!bl) break block8;
                }
                instance = FancyAudio.play$default((FancyAudio)FancyAudio.INSTANCE, (SoundEvent)((SoundEvent)TBSSounds.LIBRARY_AMBIENCE.invoke()), (SoundSource)TBSSoundCategories.TBS_MUSIC, (float)0.15f, (float)0.0f, (boolean)false, null, (int)56, null);
            }
    ...
    static {
        GameEvent.Companion.on(ClientEvents.TICK_END, LibraryAmbienceHandler::_init_$lambda$0);
    }
}
