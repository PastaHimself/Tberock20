...
@ForceRuntimeInit
@Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u00c7\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0002\u0010\u0003J\u0018\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\tH\u0002\u00a8\u0006\n"}, d2={"Lnet/thebrokenscript/handlers/NewMobDisabler;", "", "<init>", "()V", "onEntitySpawned", "", "entity", "Lnet/minecraft/world/entity/Entity;", "cancelProxy", "Lnet/thebrokenscript/brokencore/api/platform/CancelProxy;", "thebrokenscript-common"})
public final class NewMobDisabler {
    ...
    private final void onEntitySpawned(Entity entity, CancelProxy cancelProxy) {
        ...
        if (entity.getType().is(TBSTags.MODERN_MOBS) && !cancelProxy.isCanceled()) {
    ...
    static {
        EntitySpawnSubscriber.INSTANCE.add((Function2<? super Entity, ? super CancelProxy, Unit>)((Function2)new Function2<Entity, CancelProxy, Unit>((Object)INSTANCE){
            ...
            public final void invoke(Entity p0, CancelProxy p1) {
                ...
                ((NewMobDisabler)this.receiver).onEntitySpawned(p0, p1);
            }
        }));
    }
}
