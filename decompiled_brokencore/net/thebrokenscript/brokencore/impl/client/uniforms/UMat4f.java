...
@Metadata(mv={2, 1, 0}, k=1, xi=48, d1={"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u001d\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005\u00a2\u0006\u0004\b\u0007\u0010\bJ\u0010\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u0010H\u0016J\u0010\u0010\u0011\u001a\u00020\u000e2\u0006\u0010\u0012\u001a\u00020\u0013H\u0016J\b\u0010\u0014\u001a\u00020\u000eH\u0016J\b\u0010\u0015\u001a\u00020\u000eH\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u0014\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u0010\u0010\t\u001a\u0004\u0018\u00010\nX\u0082\u000e\u00a2\u0006\u0002\n\u0000R\u0010\u0010\u000b\u001a\u0004\u0018\u00010\fX\u0082\u000e\u00a2\u0006\u0002\n\u0000\u00a8\u0006\u0016"}, d2={"Lnet/thebrokenscript/brokencore/impl/client/uniforms/UMat4f;", "Lnet/thebrokenscript/brokencore/impl/client/uniforms/CustomUniform;", "name", "", "getter", "Lkotlin/Function0;", "Lorg/joml/Matrix4f;", "<init>", "(Ljava/lang/String;Lkotlin/jvm/functions/Function0;)V", "uniform", "Lcom/mojang/blaze3d/shaders/Uniform;", "sodium", "Lnet/caffeinemc/mods/sodium/client/gl/shader/uniform/GlUniformMatrix4f;", "bind", "", "shader", "Lnet/minecraft/client/renderer/ShaderInstance;", "bindSodium", "cx", "Lnet/caffeinemc/mods/sodium/client/render/chunk/shader/ShaderBindingContext;", "set", "setSodium", "brokencore-common"})
public final class UMat4f
implements CustomUniform {
    ...
    @Nullable
    private GlUniformMatrix4f sodium;

    public UMat4f(@NotNull String name, @NotNull Function0<? extends Matrix4f> getter) {
    ...
    public void bindSodium(@NotNull ShaderBindingContext cx) {
        ...
        this.sodium = (GlUniformMatrix4f)cx.bindUniformOptional(this.name, GlUniformMatrix4f::new);
    }
    ...
    public void set() {
        block0: {
            ...
            uniform.set((Matrix4f)this.getter.invoke());
        }
    }
    ...
    public void setSodium() {
        block0: {
            GlUniformMatrix4f glUniformMatrix4f = this.sodium;
            if (glUniformMatrix4f == null) break block0;
            glUniformMatrix4f.set((Matrix4fc)this.getter.invoke());
        }
    }
}
