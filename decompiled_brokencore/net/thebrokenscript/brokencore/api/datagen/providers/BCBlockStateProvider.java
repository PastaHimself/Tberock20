...
extends BlockStateProvider {
    ...
    public BCBlockStateProvider(@NotNull PackOutput output, @NotNull BrokenReg parent, @NotNull ResourceLocation id) {
        ...
        Intrinsics.checkNotNull((Object)object, (String)"null cannot be cast to non-null type B of net.thebrokenscript.brokencore.api.datagen.providers.BCBlockStateProvider");
    ...
    public void registerStatesAndModels() {
        this.parent.getData().getBlockModels().plusAssign(this.models().getJsons());
        this.parent.getData().getItemModels().plusAssign(this.itemModels().getJsons());
        this.parent.getData().getBlockStates().plusAssign(this.getStateJsons());
    }
}
