...
public interface SimpleMenuConstructor<M extends AbstractContainerMenu> {
    ...
    public static final class DefaultImpls {
        @NotNull
        public static <M extends AbstractContainerMenu> M createNoType(@NotNull SimpleMenuConstructor<M> $this, int containerId, @NotNull Inventory playerInv) {
