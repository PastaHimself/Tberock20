...
public final class BuiltInTagBuilder<T> {
    ...
    public BuiltInTagBuilder(@NotNull BrokenReg owner, @NotNull ResourceKey<? extends Registry<T>> registryKey, @NotNull String name) {
    ...
    @NotNull
    public final BuiltInTagBuilder<T> add(Holder<T> ... entries2) {
        BuiltInTagBuilder builtInTagBuilder;
        Intrinsics.checkNotNullParameter(entries2, (String)"entries");
        BuiltInTagBuilder $this$add_u24lambda_u240 = builtInTagBuilder = this;
        boolean bl = false;
        CollectionsKt.addAll((Collection)$this$add_u24lambda_u240.entries, (Object[])entries2);
        return builtInTagBuilder;
    }

    @NotNull
    public final BuiltInTagBuilder<T> add(TagKey<T> ... tags2) {
        BuiltInTagBuilder builtInTagBuilder;
        Intrinsics.checkNotNullParameter(tags2, (String)"tags");
        BuiltInTagBuilder $this$add_u24lambda_u241 = builtInTagBuilder = this;
        boolean bl = false;
    ...
    @NotNull
    public final BuiltInTagBuilder<T> add(ResourceKey<T> ... keys) {
        BuiltInTagBuilder builtInTagBuilder;
        Intrinsics.checkNotNullParameter(keys, (String)"keys");
        BuiltInTagBuilder $this$add_u24lambda_u242 = builtInTagBuilder = this;
        boolean bl = false;
     ...
     */
    @NotNull
    public final BuiltInTagBuilder<T> add(T ... entries2) {
        BuiltInTagBuilder builtInTagBuilder;
        Intrinsics.checkNotNullParameter(entries2, (String)"entries");
        BuiltInTagBuilder $this$add_u24lambda_u243 = builtInTagBuilder = this;
        boolean bl = false;
        ...
        if (registry != null) {
            ...
            for (int i = 0; i < n; ++i) {
                ...
                boolean bl3 = false;
                Optional<Holder.Reference> optional = registry2.getResourceKey((Object)it).map(arg_0 -> BuiltInTagBuilder.add$lambda$3$0$1(arg_0 -> BuiltInTagBuilder.add$lambda$3$0$0(registry2, arg_0), arg_0));
    ...
    @NotNull
    public final BuiltInTagBuilder<T> addOptional(ResourceLocation ... locations) {
        BuiltInTagBuilder builtInTagBuilder;
        Intrinsics.checkNotNullParameter((Object)locations, (String)"locations");
        BuiltInTagBuilder $this$addOptional_u24lambda_u240 = builtInTagBuilder = this;
        boolean bl = false;
    ...
    public final void plusAssign(@NotNull T entry) {
        ...
        BuiltInTagBuilder $this$plusAssign_u24lambda_u240 = this;
        boolean bl = false;
    ...
    public final void plusAssign(@NotNull Holder<T> entry) {
        Intrinsics.checkNotNullParameter(entry, (String)"entry");
        BuiltInTagBuilder $this$plusAssign_u24lambda_u241 = this;
        boolean bl = false;
    ...
    public final void plusAssign(@NotNull TagKey<T> tagKey) {
        ...
        BuiltInTagBuilder $this$plusAssign_u24lambda_u242 = this;
        boolean bl = false;
    ...
    public final void plusAssign(@NotNull ResourceKey<T> key) {
        ...
        BuiltInTagBuilder $this$plusAssign_u24lambda_u243 = this;
        boolean bl = false;
    ...
    public final void plusAssign(@NotNull T[] entry) {
        Intrinsics.checkNotNullParameter(entry, (String)"entry");
        BuiltInTagBuilder $this$plusAssign_u24lambda_u244 = this;
        boolean bl = false;
    ...
    public final void plusAssign(@NotNull Holder<T>[] entry) {
        Intrinsics.checkNotNullParameter(entry, (String)"entry");
        BuiltInTagBuilder $this$plusAssign_u24lambda_u245 = this;
        boolean bl = false;
    ...
    public final void plusAssign(@NotNull TagKey<T>[] tagKey) {
        Intrinsics.checkNotNullParameter(tagKey, (String)"tagKey");
        BuiltInTagBuilder $this$plusAssign_u24lambda_u246 = this;
        boolean bl = false;
    ...
    public final void plusAssign(@NotNull ResourceKey<T>[] keys) {
        Intrinsics.checkNotNullParameter(keys, (String)"keys");
        BuiltInTagBuilder $this$plusAssign_u24lambda_u247 = this;
        boolean bl = false;
    ...
    public final TagKey<T> register() {
        ...
        Map map = this.owner.getBuiltInTagKeys$brokencore_common();
        ...
        if (value$iv == null) {
            ...
            this.owner.getData().getBuiltInTags().plusAssign(obj);
        ...
        Intrinsics.checkNotNull((Object)object2, (String)"null cannot be cast to non-null type net.thebrokenscript.brokencore.api.registry.objects.TagObject<T of net.thebrokenscript.brokencore.api.registry.util.BuiltInTagBuilder>");
        ...
        Intrinsics.checkNotNull((Object)object3, (String)"null cannot be cast to non-null type net.minecraft.tags.TagKey<T of net.thebrokenscript.brokencore.api.registry.util.BuiltInTagBuilder>");
        return (TagKey)object3;
    }

    @NotNull
    public final TagKey<T> configure(@NotNull Function1<? super BuiltInTagBuilder<T>, Unit> block2) {
    ...
    @NotNull
    public final TagKey<T> configure(@NotNull InstanceConsumer<BuiltInTagBuilder<T>> block2) {
        Intrinsics.checkNotNullParameter(block2, (String)"block");
        return this.configure(arg_0 -> BuiltInTagBuilder.configure$lambda$1(block2, arg_0));
    }
    ...
    private static final Unit configure$lambda$1(InstanceConsumer $block, BuiltInTagBuilder $this$configure) {
