...
16. **Jimmy multipart and FracturedRoam host hierarchy are adapted** — Chunk 29 preserves the six logical part dimensions/offsets, body-yaw transforms, arrow side-effect ordering, and 103-tick SWITCHING promotion. Bedrock uses a root collision envelope plus runtime conceptual AABB filtering because it has no Java child part entities or parent/part identity. Continuous projectile sweep, exact rendered bone contact, JimArena arena/camera/music choreography, and the remaining FracturedRoam underground/dig/despawn lifecycle remain unsupported or deferred (A-016).
