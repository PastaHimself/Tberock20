...
| Bosses (Integrity P1–3, Jimmy, Kerfur) | boss/, entity/integrity/phase1..3, xcsf arena | Integrity Arena/Phase source model + source-backed Stage2 generator audit; existing boss controller; fabricated P1/P2 health-threshold transitions removed | in_progress | unknown | JS regression tests + Stage2 NBT audit + add-on CI | Source-backed model covers phase order, 150-block participant capture, Arena liveness, P1 1080/100/20/10/10 semantics, Stage2 floor bands/mappings and generator layer/template selection, and current P3 center/boundary/tentacle/end predicates. Automatic arena start, Stage2 generator/tether runtime, P3 runtime/cutscene, Jimmy, and Kerfur parity remain pending. |
