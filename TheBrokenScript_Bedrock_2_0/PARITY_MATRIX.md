...
| Bosses (Integrity P1–3, Jimmy, Kerfur) | boss/, entity/integrity/phase1..3, xcsf arena | Chunk 07 | uninspected | unknown | — | phase semantics preserved |
...
| Structures (source corpus + shaft jigsaw + xcsf) | structure/, xcsf_structure/ | Six-piece Shaft now has source-backed NBT + native Jigsaw pools/structure; remaining structure corpus and XCSF reconstruction still pending | in_progress | unknown | six Shaft source/BP Git blob SHAs match; JSON + binary-NBT connector validators present | Do not treat native Shaft assembly as full corpus/world-placement parity |
