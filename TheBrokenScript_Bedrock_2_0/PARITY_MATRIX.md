...
| Bosses (Integrity P1–3, Jimmy, Kerfur) | boss/, entity/integrity/phase1..3, fractured/, Kerfur sources | Integrity Arena/Phase source model + Phase 3 ring/boundary/GroundAttack/GroundArm/multi-attack/damage-death runtime; dedicated Fractured/Rock attack runtime (Chunk 28); source-backed Jimmy multipart model/runtime and FracturedRoam promotion adapter (Chunk 29); fabricated P1/P2 health-threshold transitions removed | in_progress | approximation | 11 multipart regressions plus preceding Jimmy/Phase3 regressions; GitHub Actions validation for Chunk 29 pending; runtime smoke pending | Phase 3 preserves ring, boundary, attacks, caps, hurt gate, mace parry, and 298-tick cleanup. Jimmy preserves 100-tick delay, selector weights, attack lengths, stomp/slam/rock/air-lift constants, Rock owner exclusion, six logical multipart definitions, arrow side-effect order, and the 103-tick roam promotion adapter. Full FracturedRoam host lifecycle, Kerfur, Java transport, and exact rendered bone contact remain pending. |
| Projectiles | chord_projectile, integ_fireball, fractured/Rock, integrity_ball damage type | Chord source-specific runtime correction (Chunk 26) + Phase 3 fireball runtime + dedicated Fractured/Rock runtime (Chunks 28–29); conceptual multipart arrow routing; explicit BrokenCore arrow-damage adapter | ported (slices) | approximation | 11 multipart regressions plus preceding Jimmy/Phase3/projectile checks; GitHub Actions validation for Chunk 29 pending | Chord uses source speed/distance/impact branches and gravity restoration; Rock preserves source 15 damage, speed 8, impact AOE, owner exclusion, and AirLift pulse. Jimmy arrow hits now require a conceptual logical part and preserve burning/spectral side-effect timing through a deferred adapter. Bone-muzzle, continuous projectile sweep, and missing BrokenCore formula remain documented adapters. |
